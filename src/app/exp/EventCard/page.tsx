...
export function EventCard({ event }: EventCardProps) {
    return (
        ...
        <main className="bg-slate-950 p-2 flex flex-col gap-2">
            <div className="h-[20vh]">
                ...
                <div className=" w-full xl:max-w-[1024px] 2xl:max-w-[1280px] mx-auto  relative p-4 border-2 bg-container bg-container-overlay border-violet-500 border-t-2 border-t-violet-500  flex flex-col   rounded-2xl" style={{ backgroundImage: `url(https://info.smartevals.com/wp-content/uploads/2024/01/image-6-1024x683.jpeg)`, }}>
                    <div className="absolute w-full h-full top-0 left-0 bg-black/50 z-1 border-1 border-violet-500 rounded-2xl"></div>
                    ...
                    <div className="flex flex-col gap-1 text-left justify-center items-start lg:max-w-2xl xl:max-w-5xl px-3 mx-auto py-2 m-2 relative z-2">
            ...
            <div className="w-full xl:max-w-[1024px] 2xl:max-w-[1280px] lg:mx-auto  relative pt-[3px] pl-[3px] pr-[3px] bg-gradient-to-b from-violet-500 via-purple-500/95 to-fuchsia-400/20 rounded-2xl">
            
                {/* This given above div is just used to  */}
                <div className=" bg-blue-600 w-full 2xl:max-w-[1280px] mx-auto relative p-4  flex flex-col gap-2 rounded-2xl">
                    <div className="w-full relative z-2  py-3 xl:py-2">
                        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 h-full">
                            <div className="flex justify-center items-center col-span-1 lg:col-span-1 md:col-span-1">
                                <button className="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 shadow-lg shadow-purple-500/50 font-semibold rounded-lg text-xl px-5 py-2.5 text-center me-2 lg:mb-2">
