...
function EventSlider({ events }: EventSliderProps) {
  ...
  return (
    <div aria-label='Event Carousel' className="lg:w-[80vw] w-screen lg:h-[65vh] relative shadow-[2px_-20px_20px_10px_rgba(0,0,0,0.2)]">
      {/* This Div is for Card */}
      <div className="w-screen h-[95%] flex overflow-hidden">
      ...
      <button onClick={nextSlide} className="img-slider-btn  right-0" style={{right:0}} aria-label="View Next Slide">
        <CircleChevronRight />
      </button>
